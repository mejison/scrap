							...
							<div class="col-lg-12 col-md-6 col-xxl-6">
								<div class="card">
									...
									<div class="card-footer pt-0 text-center border-0">
										<a href="{!! url('/social-network-campaign'); !!}">Show more<i class="fa fa-caret-down ml-3" aria-hidden="true"></i></a>
									</div>
								</div>
							</div>
							<div class="col-lg-12 col-md-6 col-xxl-6">
							...
							<div class="col-lg-12 col-md-12">
								<div class="card">
									...
									<div class="card-footer pt-0 border-0 text-center">
										<a href="{!! url('/social-network-campaign'); !!}" class="text-primary">See More Reviews</a>
									</div>
								</div>
							</div>
						</div>
