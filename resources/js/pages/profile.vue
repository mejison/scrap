                        ...
                        <div class="profile card card-body px-3 pt-3 pb-0">
                            <div class="profile-head">
                                <div class="photo-content">
                                    <div class="cover-photo" :style="'background-image: url(' + getImages(item)[1] + ')'"></div>
                                </div>
                                <div class="profile-info">
									<div class="profile-photo">
										<img :src="getImages(item)[0]" class="img-fluid rounded-circle" alt="">
									</div>
                                ...
                                <div class="profile-statistics mb-5">
                                    <div class="text-center">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <h3 class="m-b-0">-</h3><span>ENG. RATE</span>
                                            </div>
                                        </div>
                                        <div class="mt-4">
