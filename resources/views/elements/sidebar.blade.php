<div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="{!! url('/unity-search'); !!}" aria-expanded="false">
                ...
                <ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="{!! url('/viz-search'); !!}" aria-expanded="false">
                        <i class="flaticon-381-search"></i>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							...
							<li><a href="{!! url('/compaign'); !!}">Compaign</a></li>
							<li><a href="{!! url('/social-network-campaign'); !!}">Social Campaign</a></li>
							<li><a href="{!! url('/spendings'); !!}">Spendings</a></li>
							<li><a href="{!! url('/analytics'); !!}">Analytics</a></li>
							<li><a href="{!! url('/new-compaign'); !!}">New Compaign </a></li>
						</ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
