<template>
    <div class="dropdown custom-dropdown last-login mb-2">
...
export default {
    ...
    computed: {
        getLabel() {
            return this.value && this.value.length ? (this.value.length >= 2 ? "Multiple Last Login" : this.value.map(item => {
