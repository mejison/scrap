			...
			<div class="container-fluid">
				<div class="form-head d-flex mb-0 mb-lg-4 align-items-start">
					<div class="mr-auto d-none d-lg-block">
						<h2 class="text-black font-w600">Social Network Campaign</h2>
						<div>
							<a href="javascript:void(0);" class="fs-18 text-primary font-w600">Campaign / </a>
							<a href="javascript:void(0);" class="fs-18">Social Network Campaign</a>
						</div>
					</div>
						...
						<div class="flex-wrap d-flex align-items-center justify-content-between">
							<div class="d-flex flex-wrap">
								<div class="d-flex mb-3 mr-3 align-items-center bgl-primary p-0 p-lg-2 pr-lg-3 rounded">
									<i class="las la-laptop-code social-icon bg-primary mr-0 mr-lg-3 text-white"></i>
									<div class="d-none d-lg-block">
										<h5 class="text-black fs-18 mb-0">Show All</h5>
										<span class="fs-13">67,124 Campaign</span>
									</div>
								</div>
								<div class="d-flex mr-3 mb-3 align-items-center bgl-secondary p-0 p-lg-2 pr-lg-3 rounded">
									...
									<div class="d-none d-lg-block">
										...
										<span class="fs-13">457 Campaign</span>
									</div>
								</div>
								<div class="d-flex mr-3 mb-3 align-items-center bgl-info p-0 p-lg-2 pr-lg-3 rounded">
									...
									<div class="d-none d-lg-block">
										...
										<span class="fs-13">125 Campaign</span>
									</div>
								</div>
								<div class="d-flex mb-3 align-items-center bgl-success p-0 p-lg-2 pr-lg-3 rounded">
									...
									<div class="d-none d-lg-block">
										...
										<span class="fs-13">5125 Campaign</span>
									</div>
								</div>
							</div>
							<div>
								<a href="javascript:void(0);" class="btn bg-white">
					...
					<div class="col-xl-12 social-Campaign-audio">
						<div class="sca-row p-3 row align-items-center sp16 mx-0 mb-2 bg-white">
							<div class="mb-3 col-xl-4 col-xxl-3 col-md-4 col-sm-12 my-2">
								...
								<h3 class="fs-20 mb-2 text-ov mr-3"><a class="text-black" href="{!! url('/analytics'); !!}">50% OFF Floor Lamp Get it Now!</a></h3>
								<a href="javascript:;" class="lab la-facebook-f text-info mr-4"></a>
								<a href="javascript:;" class="lab la-instagram mr-4 text-secondary scale5"></a>
								<a href="javascript:;" class="lab la-twitter text-success scale5"></a>
							</div>
							<div class="col-xl-5 col-xxl-5 col-md-8 col-sm-12">									
								<div class="row">									
									...
									<div class="d-flex align-items-center col-xl-4 col-md-4 col-sm-4 my-2 col-12">
										<svg class="mr-3 min-w28 ml-2" width="28" height="24" viewBox="0 0 28 24" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path d="M7.0002 5.70001H2.8002C1.6452 5.70001 0.700195 6.62648 0.700195 7.75884V21.1412C0.700195 22.2735 1.6452 23.2 2.8002 23.2H7.0002C8.11109 23.2 9.10019 22.2293 9.10019 21.1412C9.10019 21.1412 9.10019 7.76295 9.10019 7.75884C9.10019 6.6656 8.12159 5.70001 7.0002 5.70001Z" fill="#A949D7"/>
											<path d="M27.3002 10.0897V12.8199C27.3002 13.2026 27.2298 13.5646 27.0989 13.9162L24.7141 20.4833C24.2513 21.714 23.1444 22.5 21.8765 22.5H11.2002V5.93221C11.8643 4.76357 13.3536 2.09535 13.3536 2.09535C14.1787 0.637138 16.1912 0.347563 17.3584 1.54723C17.9119 2.11603 18.2439 2.91236 18.2439 3.73972V6.98709H24.2814C25.9418 6.98709 27.3002 8.38325 27.3002 10.0897Z" fill="#A949D7"/>
										</svg>
										<div>
											<h3 class="fs-20 text-black mb-0">4,625k</h3>
											<span class="fs-14">Likes</span>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="row">	
									...
									<div class="d-flex col-xl-4 col-xxl-6 align-items-center col-md-3  col-sm-4 my-2 col-5">
										<div class="d-inline-block position-relative donut-chart-sale mr-3">
											<span class="donut1" data-peity='{ "fill": ["rgb(82, 177, 65)", "rgba(236, 236, 236, 1)"],   "innerRadius": 32, "radius": 10}'>5/8</span>
											<small>71%</small>
										</div>
						...
						<div class="sca-row p-3 row align-items-center sp16 mx-0 mb-2 bg-white">
							<div class="mb-3 col-xl-4 col-xxl-3 col-md-4 col-sm-12 my-2">
								<p class="text-primary mb-0">#ADS001246</p>
								<h3 class="fs-20 mb-2 text-ov mr-3"><a class="text-black" href="{!! url('/analytics'); !!}">15% OFF Granite Stone</a></h3>
								<a href="javascript:;" class="lab la-facebook-f text-info mr-4"></a>
								<a href="javascript:;" class="lab la-instagram mr-4 text-secondary scale5"></a>
								<a href="javascript:;" class="lab la-twitter text-success scale5"></a>
							</div>
							<div class="col-xl-5 col-xxl-5 col-md-8 col-sm-12">									
								<div class="row">									
									<div class="d-flex col-xl-4 align-items-center col-md-4 col-sm-4 my-2 col-6">
										...
										<div>
											<h3 class="fs-20 text-black mb-0">$74.02</h3>
											<span class="fs-14">Conversion</span>
										</div>
									</div>
									<div class="d-flex col-xl-4 align-items-center col-md-4  col-sm-4 my-2 col-6">
										...
										<div>
											<h3 class="fs-20 text-black mb-0">3,687k</h3>
											<span class="fs-14">Viewers</span>
										</div>
									</div>
									<div class="d-flex align-items-center col-xl-4 col-md-4 col-sm-4 my-2 col-12">
										...
										<div>
											<h3 class="fs-20 text-black mb-0">3,842k</h3>
											<span class="fs-14">Likes</span>
										</div>
									</div>
								</div>
							...
							<div class="col-xl-3 col-xxl-4 col-md-12 col-sm-12">	
								<div class="row">	
									...
									<div class="d-flex col-xl-4 col-xxl-6 align-items-center col-md-3  col-sm-4 my-2 col-5">
										<div class="d-inline-block position-relative donut-chart-sale mr-3">
											<span class="donut1" data-peity='{ "fill": ["rgb(82, 177, 65)", "rgba(236, 236, 236, 1)"],   "innerRadius": 32, "radius": 10}'>6/8</span>
											<small>71%</small>
										</div>
										<div class="dropdown ml-auto">
											<div class="btn-link" data-toggle="dropdown">
						...
						<div class="sca-row p-3 row align-items-center sp16 mx-0 mb-2 bg-white">
							<div class="mb-3 col-xl-4 col-xxl-3 col-md-4 col-sm-12 my-2">
								<p class="text-primary mb-0">#ADS001247</p>
								<h3 class="fs-20 mb-2 text-ov mr-3"><a class="text-black" href="{!! url('/analytics'); !!}">Game Online Vouchers 20% OFF</a></h3>
								<a href="javascript:;" class="lab la-facebook-f text-info mr-4"></a>
								<a href="javascript:;" class="lab la-instagram mr-4 text-secondary scale5"></a>
								<a href="javascript:;" class="lab la-twitter text-success scale5"></a>
							</div>
							<div class="col-xl-5 col-xxl-5 col-md-8 col-sm-12">									
								<div class="row">									
									<div class="d-flex col-xl-4 align-items-center col-md-4 col-sm-4 my-2 col-6">
										...
										<div>
											<h3 class="fs-20 text-black mb-0">$245.55</h3>
											<span class="fs-14">Conversion</span>
										</div>
									</div>
									<div class="d-flex col-xl-4 align-items-center col-md-4  col-sm-4 my-2 col-6">
										...
										<div>
											<h3 class="fs-20 text-black mb-0">2,412k</h3>
											<span class="fs-14">Viewers</span>
										</div>
									</div>
									<div class="d-flex align-items-center col-xl-4 col-md-4 col-sm-4 my-2 col-12">
										...
										<div>
											<h3 class="fs-20 text-black mb-0">1,254</h3>
											<span class="fs-14">Likes</span>
										</div>
									</div>
								</div>
							...
							<div class="col-xl-3 col-xxl-4 col-md-12 col-sm-12">	
								<div class="row">	
									<div class="d-flex col-xl-8 col-xxl-6 align-items-center col-md-9 col-sm-8 my-2 col-7">
										...
										<div>
											<h3 class="fs-20 text-black mb-0">6,125</h3>
											<span class="fs-14">Comments</span>
										</div>
									</div>
									<div class="d-flex col-xl-4 col-xxl-6 align-items-center col-md-3  col-sm-4 my-2 col-5">
										<div class="d-inline-block position-relative donut-chart-sale mr-3">
											<span class="donut1" data-peity='{ "fill": ["rgb(82, 177, 65)", "rgba(236, 236, 236, 1)"],   "innerRadius": 32, "radius": 10}'>4/8</span>
											<small>71%</small>
										</div>
										<div class="dropdown ml-auto">
											<div class="btn-link" data-toggle="dropdown">
