...
class EclanadminController extends Controller
{
    ...
    public function compaign()
    {
        ...
        return view('dashboard.compaign', compact('page_title', 'page_description','action','logo','logoText'));
    }
    ...
    public function new_compaign()
    {
        ...
        return view('dashboard.new_compaign', compact('page_title', 'page_description','action','logo','logoText'));
    }
	
	    // Social Network Campaign
    public function social_network_campaign()
    {
        $page_title = 'Social Network Campaign';
        $page_description = 'Some description for the page';
        $logo = "images/logo.png";
        $logoText = "images/logo-text.png";
        ...
        return view('dashboard.social_network_campaign', compact('page_title', 'page_description','action','logo','logoText'));
    }
    ...
    public function spendings()
    {
        ...
        return view('dashboard.spendings', compact('page_title', 'page_description','action','logo','logoText'));
    }
