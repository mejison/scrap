<template>
    <div class="dropdown custom-dropdown ethnicity mb-2">
...
export default {
    ...
    computed: {
        getLabel() {
            return this.value && this.value.length ? (this.value.length >= 2 ? "Multiple Ethnicities" : this.value.map(item => {
