						...
						<div class="d-lg-flex d-block pl-0 pr-0 border-0 align-items-end justify-content-between mb-3">
							<div class="">
								<a href="javascript:void(0);" class="btn bg-white mb-2 mr-2">
									<svg class="mr-2 scale5" width="14" height="14" viewBox="0 0 18 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M17.9375 4.6875V22.5625C17.9378 22.7117 17.897 22.8581 17.8196 22.9857C17.7422 23.1132 17.6312 23.217 17.4987 23.2856C17.3831 23.3449 17.2549 23.3755 17.125 23.375C16.9593 23.3746 16.7977 23.3236 16.6619 23.2288L9 17.8662L1.33813 23.2288C1.21968 23.3089 1.08218 23.3564 0.939516 23.3664C0.796853 23.3763 0.65408 23.3485 0.525625 23.2856C0.388595 23.2204 0.272581 23.118 0.190727 22.9902C0.108873 22.8624 0.064453 22.7143 0.0625 22.5625V4.6875C0.0625 3.61006 0.490512 2.57675 1.25238 1.81488C2.01425 1.05301 3.04756 0.625 4.125 0.625H13.875C14.9524 0.625 15.9858 1.05301 16.7476 1.81488C17.5095 2.57675 17.9375 3.61006 17.9375 4.6875Z" fill="#353751"/>
									</svg>
									<span class="text-black">Boookmark</span>
								</a>
								<a href="javascript:void(0);" class="btn bg-white mb-2 mr-2">
									<svg class="mr-2 scale5"  width="14" height="14" viewBox="0 0 23 22" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M9.72803 10.4999L9.72796 3.1005C9.72795 1.31868 11.8822 0.426337 13.1422 1.68627L21.0416 9.58573C21.8227 10.3668 21.8227 11.6331 21.0416 12.4142L13.1422 20.3136C11.8822 21.5735 9.72795 20.6812 9.72796 18.8994L9.72803 10.4999Z" fill="#52B141"/>
									</svg>
									<span class="text-black">Start</span>
								</a>
								<a href="javascript:void(0);" class="btn bg-white mb-2 mr-2">
									<svg class="mr-2 scale5 scale5" width="14" height="14" viewBox="0 0 12 18" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M8 1C8 0.447716 8.44772 0 9 0H11C11.5523 0 12 0.447715 12 1V17C12 17.5523 11.5523 18 11 18H9C8.44772 18 8 17.5523 8 17V1Z" fill="#8E8E8E"/>
										<path d="M0 1C0 0.447716 0.447715 0 1 0H3C3.55228 0 4 0.447715 4 1V17C4 17.5523 3.55228 18 3 18H1C0.447715 18 0 17.5523 0 17V1Z" fill="#8E8E8E"/>
									</svg>
									<span class="text-black">Pause</span>
								</a>
								<a href="javascript:void(0);" class="btn bg-white mb-2 mr-2">
									<svg  class="mr-2 scale5" width="14" height="14" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
										<rect width="14" height="14" rx="2" fill="#F83737"/>
									</svg>
									<span class="text-black">Stop</span>
								</a>
							</div>
							<div>
								<a href="javascript:void(0);" class="btn bg-white mb-2 mr-2">
					...
					<div class="campaign-audio col-md-12">
						<div class="compaign-row align-items-center p-sm-4 p-3 row sp16 mx-0 mb-2">
							<div class="my-2 col-xl-4 col-xxl-6 col-lg-6 col-md-8 col-sm-12">
								<div class="media align-items-center">
									<div class="d-inline-block position-relative donut-chart-sale mr-4">
										<span class="donut" data-peity='{ "fill": ["rgb(82, 177, 65)", "rgba(236, 236, 236, 1)"],   "innerRadius": 32, "radius": 10}'>5/8</span>
										<small>63%</small>
									</div>
									<div class="media-body">
										<p class="text-primary mb-1">#ADS001245</p>
										<h3 class="fs-20"><a class="text-black" href="{!! url('/analytics'); !!}">50% OFF Floor Lamp Get it Now!</a></h3>
										<svg width="17" height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M15 2L5 12.01L2 9.01" stroke="#737373" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
										</svg>
							...
							<div class="col-xl-2 col-xxl-6 col-lg-6 col-md-4 col-sm-8 px-3">
								<div class="row align-items-center my-2">
									<div class="col-6">
										...
										<span class="fs-14">Today Spends</span>
									</div>
									<div class="col-6">
							...
							<div class="col-xl-2 col-xxl-4 col-lg-4 col-md-6 text-center my-2 col-sm-4">
								<a class="btn btn-outline-dark p-3 text-ov" href="javascript:void(0);">
								<svg class="mr-2 scale5" width="14" height="14" viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path d="M12.1583 3.8476H1.93099C0.971333 3.8476 0.191895 4.62703 0.191895 5.58669V20.2608C0.191895 21.2205 0.971333 21.9999 1.93099 21.9999H12.1583C13.118 21.9999 13.8974 21.2205 13.8974 20.2608V5.58669C13.8929 4.62703 13.1135 3.8476 12.1583 3.8476ZM12.6764 20.2563C12.6764 20.5447 12.4422 20.779 12.1538 20.779H1.92648C1.63814 20.779 1.40385 20.5447 1.40385 20.2563V5.58669C1.40385 5.29834 1.63814 5.06406 1.92648 5.06406H12.1538C12.4422 5.06406 12.6764 5.29834 12.6764 5.58669V20.2563Z" fill="#8E8E8E"/>
									<path d="M16.069 0H5.84163C4.88198 0 4.10254 0.779439 4.10254 1.73909C4.10254 2.077 4.37286 2.34733 4.71077 2.34733C5.04868 2.34733 5.319 2.077 5.319 1.73909C5.319 1.45075 5.55329 1.21647 5.84163 1.21647H16.069C16.3573 1.21647 16.5916 1.45075 16.5916 1.73909V16.4133C16.5916 16.7016 16.3573 16.9359 16.069 16.9359C15.731 16.9359 15.4607 17.2062 15.4607 17.5441C15.4607 17.882 15.731 18.1524 16.069 18.1524C17.0286 18.1524 17.808 17.3729 17.808 16.4133V1.73909C17.808 0.779439 17.0286 0 16.069 0Z" fill="#8E8E8E"/>
								</svg>
								https://eclan.io/campaign0123...</a>
							</div>
							<div class="col-xl-4 col-xxl-8 col-lg-8 col-md-6 text-left text-md-right my-2">
								<a href="javascript:void(0);" class="btn bgl-primary text-primary cl-btn ">On Going</a>
								<a href="javascript:void(0);" class="border border-primary audio-btn ml-2">
									<svg width="20" height="18" viewBox="0 0 13 20" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path d="M0.272217 9.5L0.272153 2.10056C0.272138 0.318742 2.42643 -0.573602 3.68637 0.686334L11.5858 8.58579C12.3669 9.36684 12.3669 10.6332 11.5858 11.4142L3.68636 19.3137C2.42643 20.5736 0.272136 19.6813 0.27215 17.8994L0.272217 9.5Z" fill="#52B141"/>
									</svg>
								</a>
								<a href="javascript:void(0);" class="border border-dark audio-btn ml-2">
									<svg width="12" height="18" viewBox="0 0 12 18" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M8 1C8 0.447716 8.44772 0 9 0H11C11.5523 0 12 0.447715 12 1V17C12 17.5523 11.5523 18 11 18H9C8.44772 18 8 17.5523 8 17V1Z" fill="#8E8E8E"/>
										<path d="M0 1C0 0.447716 0.447715 0 1 0H3C3.55228 0 4 0.447715 4 1V17C4 17.5523 3.55228 18 3 18H1C0.447715 18 0 17.5523 0 17V1Z" fill="#8E8E8E"/>
									</svg>
								</a>
								<a href="javascript:void(0);" class="border border-danger audio-btn ml-2">
						...
						<div class="compaign-row align-items-center p-sm-4 p-3 row sp16 mx-0 mb-2">
							<div class="my-2 col-xl-4 col-xxl-6 col-lg-6 col-md-8 col-sm-12">
								<div class="media align-items-center">
									<div class="d-inline-block position-relative donut-chart-sale mr-4">
										<span class="donut" data-peity='{ "fill": ["rgb(82, 177, 65)", "rgba(236, 236, 236, 1)"],   "innerRadius": 32, "radius": 10}'>3/8</span>
										<small>38%</small>
									</div>
									<div class="media-body">
										<p class="text-primary mb-1">#ADS001245</p>
										<h3 class="fs-20"><a class="text-black" href="{!! url('/analytics'); !!}">15% OFF Granite Stone</a></h3>
										<svg width="17" height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M15 2L5 12.01L2 9.01" stroke="#737373" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
										</svg>
										<span class="fs-14 ml-1">Published on 5 March 2020</span>
						...
						<div class="compaign-row align-items-center p-sm-4 p-3 row sp16 mx-0 mb-2">
							<div class="my-2 col-xl-4 col-xxl-6 col-lg-6 col-md-8 col-sm-12">
								<div class="media align-items-center">
									<div class="d-inline-block position-relative donut-chart-sale mr-4">
										<span class="donut" data-peity='{ "fill": ["rgb(82, 177, 65)", "rgba(236, 236, 236, 1)"],   "innerRadius": 32, "radius": 10}'>4/8</span>
										<small>50%</small>
									</div>
									<div class="media-body">
										<p class="text-primary mb-1">#ADS001245</p>
										<h3 class="fs-20"><a class="text-black" href="{!! url('/analytics'); !!}">Game Online Vouchers 20% OFF</a></h3>
										<svg width="17" height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M15 2L5 12.01L2 9.01" stroke="#737373" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
										</svg>
										<span class="fs-14 ml-1">Published on 5 March 2020</span>
						...
						<div class="compaign-row align-items-center p-sm-4 p-3 row sp16 mx-0 mb-2">
							...
							<div class="col-xl-4 col-xxl-8 col-lg-8 col-md-6 text-left text-md-right my-2">
								<a href="javascript:void(0);" class="btn bgl-danger text-danger cl-btn">Expired</a>
								<a href="javascript:void(0);" class="border border-primary audio-btn ml-2">
									<svg width="20" height="18" viewBox="0 0 13 20" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path d="M0.272217 9.5L0.272153 2.10056C0.272138 0.318742 2.42643 -0.573602 3.68637 0.686334L11.5858 8.58579C12.3669 9.36684 12.3669 10.6332 11.5858 11.4142L3.68636 19.3137C2.42643 20.5736 0.272136 19.6813 0.27215 17.8994L0.272217 9.5Z" fill="#52B141"/>
									</svg>
